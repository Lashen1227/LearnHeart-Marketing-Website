  ...
  return (
    <section id="features" className="text-gray-600 body-font">
      <div className="px-3 py-5 mx-auto text-center sm:mx-6 md:mx-12 md:pt-5 md:mt-5 xl:mx-40">
        <h1 className="text-2xl font-medium text-blue-950 sm:text-4xl">
          Core Features
        </h1>
        <Carousel
        ...
        >
          {/* Carousel Items */}
          <div className="p-6 mx-2 transition-transform duration-300 rounded-lg shadow-lg hover:scale-105 bg-[#d9d9d9] h-96 border border-blue-900">
          ...
          <div className="p-6 mx-2 transition-transform duration-300 bg-[#d9d9d9] rounded-lg shadow-lg hover:scale-105 h-96 border border-blue-900">
            <h2 className="text-lg font-medium text-gray-900">
              User Dashboard
            </h2>
